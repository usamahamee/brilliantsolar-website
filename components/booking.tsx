      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div
            ...
            style={{ minHeight: 1631 }}
            dangerouslySetInnerHTML={{
              __html: `
                <iframe
                  src="https://api.leadconnectorhq.com/widget/form/PFcoSoS5s3JbJdfRKyQU"
                  style="width:100%;height:100%;min-height:1631px;border:none;border-radius:3px"
                  id="inline-PFcoSoS5s3JbJdfRKyQU"
                  ...
                  data-height="1631"
                  data-layout-iframe-id="inline-PFcoSoS5s3JbJdfRKyQU"
                  data-form-id="PFcoSoS5s3JbJdfRKyQU"
